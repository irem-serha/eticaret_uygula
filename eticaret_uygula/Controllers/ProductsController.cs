...
namespace eticaret_uygula.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Products products,IFormFile ImageUpload)
        {
            if (ImageUpload != null)
            {
                var uzanti = Path.GetExtension(ImageUpload.FileName);
            ...
            {
                var sorgu =await _context.Products.FindAsync(products.ProductId);
                products.ProductPicture = sorgu.ProductPicture;
            }
